...
public class AdminBizImpl implements AdminBiz {
	...
	private ReturnT<String> callback(HandleCallbackParam handleCallbackParam) {
		...
		if (IJobHandler.SUCCESS.getCode() == handleCallbackParam.getExecuteResult().getCode()) {
			...
			callbackMsg = "<br><br><span style=\"color:#F39C12;\" > >>>>>>>>>>>"
					+ I18nUtil.getString("jobconf_exe_fail_retry") + "<<<<<<<<<<< </span><br>";

			callbackMsg += MessageFormat.format(
					I18nUtil.getString("jobconf_callback_msg1"), (retryTriggerResult.getCode() == ReturnT.SUCCESS_CODE
							? I18nUtil.getString("system_success") : I18nUtil.getString("system_fail")),
